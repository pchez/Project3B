...
def checkUnallocInodes():
	for inode_num in range(1,int(superblock[1])):
		if inode_num not in range(1,int(superblock[6])) and inode_num not in ifree and inode_num not in inode.keys():
